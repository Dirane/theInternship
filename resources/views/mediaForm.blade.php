	...
	<h2> @lang('sentence.apply_internship')</h2>
				<input type="hidden" name="company_id" value="{{ $company_id }}" />
					<div class="col-md-2 col-sm-4 {{ $errors->has('application_type') ? ' has-error' : '' }}">
                        ...
                        <center>@lang('sentence.application_type') <a style="display: inline-block;" href="#" class="cant-find" data-missing="application_type" >{{-- @lang('sentence.cant_find',['name' => 'application_type']) --}}</a></center>
                    ...
                    <div class="form-group{{ $errors->has('application_letter_text') ? ' has-error' : '' }}">
                            <label for="application_letter_text" class="col-md-4 control-label">@lang('sentence.application_letter')</label>
                    ...
                    <div class="col-sm-3 col-xs-12 col-p-5 ">
                        ...
                        <div class="form-group{{ $errors->has('multivation_letter') ? ' has-error' : '' }}">
                            <label for="multivation_letter" class="col-md-4 control-label">@lang('sentence.multivation_letter')</label>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <button type="submit" class="btn btn-primary pull-right"> @lang('word.submit')</button>
